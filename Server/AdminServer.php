...
switch ($_POST['function']) {
  case 'login':
    echo login($_POST['ID'], $_POST['password'],$_POST['Last_Access_time']);
    break;
  case 'updateInfo':
    echo updateInfo($_POST['ID'], $_POST['Name'], $_POST['Amount'], $_POST['Price']);
    break;
  case 'updateP':
            echo updateP($_GET['ID'], $_GET['password']);
            break;
  case 'addNewUser':
    echo addNewUser($_POST['ID'], $_POST['Name'], $_POST['Amount'], $_POST['Price']);
    break;
  case 'getUsersFromDB':
    echo getUsersFromDB($_POST['withSearch'], $_POST['searchBy'], $_POST['searchField']);
    break;
  case 'deleteUser':
